        ...
        <div class="row form__contacts">
            <div class="col-md-12">
                <div class="form-group form__email {{ $errors->has('name') ? ' has-error' : '' }}">
                    ...
                    <input type="text" name="user_name" class="form__imput" placeholder="{{ trans('main.name') }}"  required />
                    <input type="hidden" name="book_id" class="form__imput" value="{{$bok->id}}"/>
                    @if ($errors->has('name'))
...
{{--                </div>--}}
            ...
            <div class="form-group form__button">
                <input type="submit" name="btnSubmit" class="btn btn-primary btn-round btn-sm" value="{{ trans('main.write_comment') }}" />
            </div>
        </div>
    </form>
</div>
