...
{{--                <a href="#box" class="lang-flag {{ app()->getLocale() }}" onclick="openbox('box'); return false">{{ trans('header.language') }}</a>--}}
    ...
    <div id="avatar" class="header__menu">
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a href="#home" class="menu-item">Институт <i class="fas fa-chevron-down"></i>
            ...
            <a href="#news" class="menu-item">Научные проекты <i class="fas fa-chevron-down"></i>
                <ul class="sub-menu sub-menu-mod">
                    <li><div onclick="location.href='/news'">Издания и публикации</div></li>
                    <li><div onclick="location.href='/keuren'">Антологии, изданные в рамках программы «Семь граней великой степи»</div></li>
                    <li><div>Золотой фонд</div></li>
                </ul>
            </a>
            <a href="#contact" class="menu-item">Мероприятия</a>
            <a href="#about" class="menu-item">Интеграция образования и науки</a>
            <a href="#about" class="menu-item">Научный журнал "Keruen"</a>
            <a href="#about" class="menu-item">НКЦ "Дом музей Ауэзова"</a>
