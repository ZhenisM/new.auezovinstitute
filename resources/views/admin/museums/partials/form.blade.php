...
<input type="text" class="form-control" name="title_kk" placeholder="Заголовок" value="{{$museum->title_kk ?? ""}}" required><br>

<label for="">Заголовок ru</label>
<input type="text" class="form-control" name="title_ru" placeholder="Заголовок" value="{{$museum->title_ru ?? ""}}" required><br>

<label for="">Заголовок en</label>
<input type="text" class="form-control" name="title_en" placeholder="Заголовок" value="{{$museum->title_en ?? ""}}" required><br>
...
<textarea class="form-control" id="description" name="description_kk">{{$museum->description_kk ?? ""}}</textarea>

<label for="">Полное описание ru</label>
<textarea class="form-control" id="description" name="description_ru">{{$museum->description_ru ?? ""}}</textarea>

<label for="">Полное описание en</label>
<textarea class="form-control" id="description" name="description_en">{{$museum->description_en ?? ""}}</textarea>
