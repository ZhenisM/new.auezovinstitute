...
class ScController extends Controller
{
    public function index()
    {
        ...
        $sciences = Science::all('id', 'title_' . \App::getLocale() . ' as title', 'image_show', 'description_' . \App::getLocale() . ' as description');
    ...
    public function show($id)
    {
        ...
        $halyks = HalykUniversity::orderBy('id', 'desc')->where('locale', \App::getLocale())->where('published', 1)->paginate(12);
        $keruens = Keruen::orderBy('id', 'desc')->where('locale', \App::getLocale())->where('published', 1)->paginate(12);
        $science = Science::all('id', 'title_' . \App::getLocale() . ' as title', 'image_show', 'description_' . \App::getLocale() . ' as description')->where('id', $id)->first();
        $aboutses = Inst::orderBy('id', 'desc')->where('locale', \App::getLocale())->where('published', 1)->paginate(12);
        $cultures = Culture::orderBy('id', 'desc')->where('locale', \App::getLocale())->get();
    ...
    public function young($id)
    {
        return view('sciences.young');
    }

    public function council($id)
    {
        return view('sciences.council');
    }
}
