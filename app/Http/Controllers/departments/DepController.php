...
class DepController extends Controller
{
    ...
    public function index()
    {
        ...
        $departs = Departments::all('id', 'title_' . \App::getLocale() . ' as title', 'description_short_' . \App::getLocale() . ' as description_short', 'description_' . \App::getLocale() . ' as description');
    ...
    public function show($id)
    {
        ...
        $halyks = HalykUniversity::orderBy('id', 'desc')->where('locale', \App::getLocale())->where('published', 1)->paginate(12);
        $keruens = Keruen::orderBy('id', 'desc')->where('locale', \App::getLocale())->where('published', 1)->paginate(12);
        $depart = Departments::all('id', 'title_' . \App::getLocale() . ' as title', 'description_short_' . \App::getLocale() . ' as description_short', 'description_' . \App::getLocale() . ' as description')->where('id', $id)->first();
        $aboutses = Inst::orderBy('id', 'desc')->where('locale', \App::getLocale())->where('published', 1)->paginate(12);
        $cultures = Culture::orderBy('id', 'desc')->where('locale', \App::getLocale())->get();
