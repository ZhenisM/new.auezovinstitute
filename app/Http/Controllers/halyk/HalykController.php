...
class HalykController extends Controller
{
    public function index()
    {
        ...
        $halyks = HalykUniversity::all('id', 'title_' . \App::getLocale() . ' as title', 'description_' . \App::getLocale() . ' as description', 'image', 'image_show', 'created_at', 'published')
            ->where('published', 1)->where('id', 1);
    ...
    public function show($id)
    {
        ...
        $keruens = Keruen::orderBy('id', 'desc')->where('locale', \App::getLocale())->where('published', 1)->paginate(12);
        //$halyks = HalykUniversity::orderBy('id', 'desc')->where('locale', \App::getLocale())->where('published', 1)->paginate(12);
        $halyk = HalykUniversity::all('id', 'title_' . \App::getLocale() . ' as title', 'description_' . \App::getLocale() . ' as description', 'image', 'image_show', 'created_at', 'published')
